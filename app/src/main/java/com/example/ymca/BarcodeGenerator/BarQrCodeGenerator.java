...
package com.example.ymca.BarcodeGenerator;

/**
 *
 * @author JOHN
 */
public class BarQrCodeGenerator {
       private String codeStringValue;
    private String generatedCode;

    public BarQrCodeGenerator(String codeString)
    {
    ...
    {
       //int codeAsNumber = Integer.valueOf(codeStringValue).intValue();
